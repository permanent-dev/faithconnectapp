        ...
        <nav className="p-4 ">
            <div className="flex justify-between gap-20 items-center">
                ...
                <ul className="hidden md:flex gap-30 text-lg font-bold">
                    ...
                    <li><Link to="/books" className="capitalize text-[#000000] text-[2.5rem]">books</Link></li>
                    <li><Link to="/blog" className="capitalize text-[#000000] text-[2.5rem]">blog</Link></li>
                    <li><Link to="/aboutus" className="capitalize text-[#000000] text-[2.5rem]">about us</Link></li>
                    <li><Navbutton /></li>
            ...
            <div
                className={`md:hidden fixed capitalize top-0 left-0 h-full w-2/3 bg-gray-400 shadow-md z-[10] transform transition-transform duration-300 ${isOpen ? "translate-x-0" : "-translate-x-full"
                    }`}
            >
